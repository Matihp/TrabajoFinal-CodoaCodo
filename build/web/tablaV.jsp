            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h2 class="mb-0 fw-bold text-success">Oradores Inscriptos</h2>
                    </div>
                    <form action="Controlador" method="POST" class="mb-3">                 
                        <input  class="btn btn-sm btn-success p-1 mb-3 fw-bold" type="submit" name="accion" value="Mostrar"> 
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${datos2}"> 
                                    <tr>
                                        <td>${dato.getId()}</td> 
                                        ...
                                        <td>
                                            <form action="Controlador" method="POST">   
                                                ...
                                                <input class="btn btn-sm btn-outline-success" type="submit" name="accion" value="Edit">
                                                <input class="btn btn-sm btn-outline-danger" type="hidden" name="accion" value="Delete">

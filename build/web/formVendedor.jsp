                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item ">*Mirar Notificaciones*</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="d-flex">
                                    <div class="col-sm-12">
                                        <h5 class="">Felicitaciones ${vendedor.nombreUsuario}! 🎉</h5>
                                        <p class="mb-4">
                                            Has realizado el <span class="fw-bold">72%</span> de ventas totales! Eres el
                                            empleado
                                            que realizó más ventas el día de hoy. Resaltas por tu compromiso diario y tu
                                            capacidad de trabajo en equipo. Excelente trabajo.
                                        </p>
                                        <a href="" class="btn btn-sm btn-outline-success">Ver Insignias</a>
                                    </div>
                                </div>
                                <div class="col-sm-5 text-center text-sm-left">
                                    <div class="card-body pb-0 px-0 px-md-4">
                                        <img class="d-none d-xl-block" src="dist/img/congrats.jpg" height="140" alt="Exito" />
                                        <img class="d-xl-none" src="dist/img/congratsSM.jpg" height="140" alt="Exito" />
                                    </div>
                                </div>
                            </div>
                        </div>

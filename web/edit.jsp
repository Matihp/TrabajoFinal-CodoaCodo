    ...
    <div class="sidebar">
        <nav class="navbar bg-dark navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="#" class="nav-item nav-link"><i class="fa-regular fa-handshake fa-lg me-2 i-col"></i>Bancos</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand bg-dark navbar-light sticky-top px-4 py-0">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img class="rounded-circle flex-shrink-0  user-wh" src="dist/img/${usuario.nombreUsuario}.jpg" alt="Imagen Usuario">
            ...
            <div class="bg-light text-center rounded p-4">
                <div class="align-middle mb-3">
                    ...
                    <form action="Controlador" method="POST">
                        ...
                        <br><br>
                        <input class="btn btn-success mt-3" type="submit" value="Actualizar" name="accion">
                    </form>    
                </div>
            </div>
        </div>
